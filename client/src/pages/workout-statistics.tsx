      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center p-4 bg-slate-700 rounded-xl flex flex-col items-center justify-center">
              <div className="text-xl font-bold text-white mb-1">{totalStats.totalReps}</div>
              <div className="text-xs text-slate-400 text-center">Total Reps</div>
            </div>
            <div className="text-center p-4 bg-slate-700 rounded-xl flex flex-col items-center justify-center">
              <div className="text-xl font-bold text-white mb-1">{totalStats.totalCompletedDays}</div>
              <div className="text-xs text-slate-400 text-center">Days Completed</div>
            </div>
            <div className="text-center p-4 bg-slate-700 rounded-xl flex flex-col items-center justify-center">
        ...
        <div className="bg-slate-800 rounded-xl p-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center p-4 bg-slate-700 rounded-xl flex flex-col items-center justify-center">
              ...
              <div className="text-xs text-slate-400 text-center">Monthly Reps</div>
            </div>
            <div className="text-center p-4 bg-slate-700 rounded-xl flex flex-col items-center justify-center">
