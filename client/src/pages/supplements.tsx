...
import { ArrowLeft, Pill, Plus, Edit2, Trash2, Calendar } from "lucide-react";
  ...
  return (
    <div className="p-4 max-w-3xl mx-auto min-h-screen pb-32" style={{ backgroundColor: 'hsl(222, 47%, 11%)' }}>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl transition-colors"
            >
        ...
        {/* Manage Supplements */}
        <div className="bg-slate-800 rounded-xl p-6">
          <h2 className="text-lg font-semibold text-white mb-4">Manage Supplements</h2>
